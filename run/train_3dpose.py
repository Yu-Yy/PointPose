...
from depth_core.function import train_depth, validate_depth, train_points3d
...
def main():
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        train_points3d(config, model, optimizer, train_loader, epoch, final_output_dir, writer_dict)
        if epoch % 2 ==  0:
